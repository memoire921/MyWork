...
@AllArgsConstructor // 모든 멤버변수 생성자 주입하므로 각각 @Autowired 할 필요없음
public class MemberController {
	...
	public String join(HttpServletRequest request, 
		...
		if (realPath.contains(".eclipse.")) // 개발중 (배포전: eclipse 개발환경)
			realPath = "C:\\Users\\leejk\\Desktop\\leejk\\MTest\\MyWork\\demo\\src\\main\\webapp\\resources\\uploadImages\\";
		...
		if ( !f1.isFile() ) {  // 존재하지 않는 경우
			String basicImagePath 
					= "C:\\Users\\leejk\\Desktop\\leejk\\MTest\\MyWork\\demo\\src\\main\\webapp\\resources\\Images\\basicman4.png";
