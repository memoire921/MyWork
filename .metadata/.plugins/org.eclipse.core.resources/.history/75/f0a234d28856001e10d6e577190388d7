...
public class Ex01_StoreTest {
   ...
   public static void main(String[] args) {
      ...
      g1.setData(123.456); // Generic 이 적용안됨 -> Object
      
      // => Integer Type 으로 생성한 인스턴스는 Integer Type 만 사용가능
      StoreG<Integer> g2 = new StoreG<Integer>();
      g2.setData(12345);
      //g2.setData(124.456); -> 컴파일 오류
      
      // => Ex01_Car Type 으로 생성한 인스턴스는 Integer Type 만 사용가능
      StoreG<Ex01_Car> g3 = new StoreG<Ex01_Car>();
      g3.setData(new Ex01_Car(100, 500, "Silver"));
      
      //StoreG<int> g2 = new StoreG<int>();
      // => 객체형만 가능, 기본자료형 사융불가능(Wrapper_Class 사용하면됨)
   } //main
