...
//-> 아래 매핑 메서드들 처럼, ModelAndView 보다 심플한 코드작성 가능하므로 많이사용됨. 
...
public class MemberController {
	...
	//@Autowired  // @AllArgsConstructor 가 있기 때문에 @Autowired 의미없음.
...
//	}
	// => 계층적 url 적용
	//    home 에서의 요청명읜 "member/memberList"
...
//	} //login_Get
	...
	public String logout(HttpSession session, Model model, RedirectAttributes rttr) {
		...
		// => 단, request 에 보관한 값들은 사라지므로 위의 메시지 처리를 고려해야함.
		// => session 에 보관 ( 이미 세션을 무효화 했으므로 500 발생 )
...
//	}
	...
	public String join(HttpServletRequest request, 
		...
		if (realPath.contains(".eclipse.")) // 개발중 (배포전: eclipse 개발환경)
			...
			//=> 필요한경로:   C:\Users\leejk\Desktop\leejk\MTest\IDESet\apache-tomcat-9.0.41\webapps\Spring02\resources\~ploadImages
		...
		if ( !f1.isFile() ) {  // 존재하지 않는 경우
			String basicImagePath 
					= "C:\\Users\\leejk\\Desktop\\leejk\\MTest\\MyWork\\Spring02\\src\\main\\webapp\\resources\\Images\\basicman4.png";
		...
		if ( uploadfilef != null && !uploadfilef.isEmpty() ) {
			// => image_File 을 선택함 -> 저장 (저장경로: realPath + 화일명)
		...
		// ** *********************************************************************
		// 키보드 테스트.. 키보드 아주 좋구만유... 흐흐흐 키보드 탐나는구만유 후후후
		// 근데 계속 쳐보니까 좋으면서... 안좋은 느낌...... 음.... 익숙하지 않아서 그런가... 흠........
		// 손목이 좀 아픈거 같기두 하면서........hmmmm........
		// 그래도 디자인은 아주 예쁘군요 ... 근데................... 흠,,,,,,,,
		// 팟팅!!!!
		// => 진짜 ... 티비 수리 스킬..... 몰랐어요
		// => 하핫 ..! 꾸르잼 honey 잼
