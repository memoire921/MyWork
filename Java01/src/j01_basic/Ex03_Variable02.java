package j01_basic; // package 이름

// ** 치환, 기본자료형의 Wrapper Class, Overflow

public class Ex03_Variable02 { // class 이름
	...
	public static void main(String[] args) {
		...
		String cup1="사이다";
		String cup2="콜라";
		// cup1="콜라";  cup2="사이다"; XXXXXX
		String temp=cup1; // cup1의 값 보관
		cup1=cup2;
		cup2=temp;
		...
		System.out.println("** 정수형 의   Literal 의 범위 **");
		System.out.println("** byte => "+Byte.MIN_VALUE+" ~ "+Byte.MAX_VALUE);
		System.out.println("** short => "+Short.MIN_VALUE+" ~ "+Short.MAX_VALUE);
		System.out.println("** int => "+Integer.MIN_VALUE+" ~ "+Integer.MAX_VALUE);
		System.out.println("** long => "+Long.MIN_VALUE+" ~ "+Long.MAX_VALUE);
		
		System.out.println("** 실수형 의   Literal 의 범위 **");
		...
		//sMax=Short.MAX_VALUE+1;
		// => short 오버플로우(Overflow) Test : 최소값과 동일(오류 안생김)
		...
		//               -> 1 0000 0000 0000 0000 -> 최대값의 +1로 오버플로우가 일어나게 되면, 우측의 2byte 만 남게됨

		// => short 언더플로우(Underflow) Test : 최대값과 동일
		System.out.printf("** s_Underflow1 => sMin=%d,  sMin-1=%d \n", sMin, (sMin-1)); // 정상적 int 연산
