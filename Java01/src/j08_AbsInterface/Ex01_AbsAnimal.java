...
class Eagle extends Animal {
	public Eagle() { kind = "한화이글스";}
	@Override
	void sound() { System.out.println("~~ 당당하게 한숨 쉬며 또 졌습니다 ~~"); }
	@Override
	void special() { System.out.println("~~ 오늘도 병살타에 수비진들 실책 연속! ~~"); }
} //Eagle

class Bear {
	void breath() { System.out.println("~~ 곰은 숨을 쉽니다 ~~"); }
	void sound() { System.out.println("~~ 크왕 크왕 ~~"); }
...
public class Ex01_AbsAnimal {
	...
	public static void animalUse(Object animal) {
		System.out.println("** Your Address => " + animal); // animal.toString() 이 적용과 동일
	}
