...
// ** @FunctionalInterface (예제 Lm01_02~~,Lm01_03~~ 참고 )
...
class Printer implements Printable {
	...
	public void myTest(String s) {
		System.out.println("** LamdaTest 1. 일반적인 방법 => " + s);
	}
} //Printer
...
public class Lm01_Basic {
	...
	public static void main(String[] args) {
		...
		@Override
			public void myTest(String s) {
				System.out.println("** LamdaTest 2. 익명클래스 적용 => " + s);
			}	
		};
		p2.myTest("재밌어요 ~~~");
		...
		// => 매개변수가 하나이면 ( ) 생략가능
		Printable p3 = s -> {
			System.out.println("** LamdaTest 3. Lamda식 표현 => " + s);
		};
		p3.myTest("편리해요 ~~");
		...
		p4.myTest("** LamdaTest 4. 메서드참조 람다식");
