...
public class Ex04_LocalInner {
	...
	public void innerTest(int n) {
		int b = 200;
		final int C = n;
		System.out.printf("** innerTest 1 : a = %d, b = %d, C = %d \n", a, b, C);
		...
		System.out.printf("** innerTest 2 : a = %d, b = %d, C = %d \n", a, b, C); //확인용
	...
	public static void main(String[] args) {
		...
		// => Inner 클래스 생성시점 : 메서드 호출시 메서드 내부의 생성문 싱행시점에 생성
		Ex04_LocalInner ex04 = new Ex04_LocalInner();
		ex04.innerTest(300); 
		// => 메서드 호출 : innerTest 1 -> innerTest 2 
