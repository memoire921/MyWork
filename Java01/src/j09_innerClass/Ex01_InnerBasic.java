...
class OuterClass {
    ...
    //    (단, inner 클래스가 외부에서 접근 불가능한 멤버는 아님)
	Ex01_Car car;
	...
	static class Inner {
		...
		//    -> Outer 의 non_static 멤버 접근시 인스턴스가 필요함
		...
		//   -> Outer, Inner 의 모든 non_static 멤버 접근시 인스턴스가 필요함
		...
		//    Outer 의 static, non_static, private 등 모든멤버 에 접근 가능
...
public class Ex01_InnerBasic {
	...
	public static void main(String[] args) {
        ...
        // 3.1) static Inner 의 static 멤버접근
        ...
        // 3.2) static Inner 의 non_static 멤버접근
