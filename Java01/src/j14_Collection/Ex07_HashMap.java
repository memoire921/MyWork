...
public class Ex07_HashMap {
	...
	public static void main(String[] args) {
		...
		// 1.4) 활용
		// => get, remove : key 로 접근
		System.out.println("** HashMap get(20) => " + hMap.get(2)); // key = 20 인 자료
		System.out.println("** HashMap remove(20) => " + hMap.remove(2)); // 삭제 & Value return
		...
		// => 입력순 을 유지, 단 위 경우에는 처리과정에서 전달된 순서를 유지함
		// => 확인
