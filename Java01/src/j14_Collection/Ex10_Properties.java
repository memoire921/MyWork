...
public class Ex10_Properties {
	...
	public static void main(String[] args) {
		...
		pp.setProperty("updata", "StudentUpdata.java");
		//pp.setProperty(111, "StudentDelete.java"); -> String, String 만 허용 (컴파일오류)
		pp.put("delete", "StudentDelete.java");
		//pp.put(111, 1234567); -> 밑에 순차처리 상에서 String 으로 형변환을 했기 때문에 Error 발생. 주석처리. 
		// -> put 의 경우에는 String, String 만 허용되야 하는데 JDK 11 에서는 허용됨
