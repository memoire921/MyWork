...
public class Ex05_static {
	...
	public static int add(int i, int j, Ex05_static ex00) {
		...
		// static 메서드에서 static 은 인스턴스가 있어야 접근 가능
		ex00.itotal += (i + j);
	...
	public static void main(String[] args) {
		...
		System.out.println("** main itotal => " + total);
		System.out.println("** main result => " + ex05.itotal);	
		...
		System.out.println("** main2 itotal => " + total);
		System.out.println("** main2 result => " + ex055.itotal);	
		...
		System.out.println("** test1 => " + ex05.total); // 경고, 바람직한 접근은 아님
