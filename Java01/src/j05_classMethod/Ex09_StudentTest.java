...
// ** 클래스 구성요소 : 멤버
// => 멤버변수(필드 field, 컬럼 colum): 전역(Global)변수
// => 메서드
...
public class Ex09_StudentTest {
	...
	public static void main(String[] args) {
		...
		Student s2 = new Student("어성은", 2, 20, 70, 80, 100);
		// String name="가나다라",  int age=100; 과 동일한 선언문 (비교)
		
		Student[] sss = {s1, s2,
				new Student("이진기", 3, 30, 90, 80, 30),
				new Student("유희상", 4, 40, 80, 70, 40),
				new Student("홍길동", 5, 50, 90, 80, 50) };
