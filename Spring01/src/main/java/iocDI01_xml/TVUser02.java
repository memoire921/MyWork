...
public class TVUser02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("** singleton(싱글톤) Test **"); TV tvl =
		 * (TV)sc.getBean("mytv"); TV tvs1 = (TV)sc.getBean("sstv"); TV tvs2 =
		 * (TV)sc.getBean("sstv");
		 * 
		 * // => 인스턴스 출력 비교 System.out.println("** tv_lg => "+tv); //singleton (같은주소)
